...
using PrestApp.Models.AboutUs;
using Xamarin.Forms;
using Xamarin.Forms.Internals;

namespace PrestApp.ViewModels.AboutUs
{
    /// <summary>
    ...
    public class AboutUsViewModel : INotifyPropertyChanged
    {
        ...
        /// <summary>
        /// Initializes a new instance for the <see cref="T:PrestApp.ViewModels.AboutUs.AboutUsViewModel"/> class.
        /// </summary>
